Locales['sc'] = {
  ...
  ['gave_weapon_ammo'] = '你把~o~%sx~s~~b~%s~s~弹药赠给了~y~%s~s~',
  ['gave_weapon_withammo'] = '你把~b~%s~s~和~o~%sx~s~弹药赠给了~y~%s~s~',
  ['gave_weapon_hasalready'] = '~y~%s~s~已经拥有~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~没有那个武器',
  ['received_weapon'] = '你收到了~b~%s~s~，来自~b~%s~s~',
  ['received_weapon_ammo'] = '你收到了~o~%sx~s~弹药(~b~%s~s~)，来自~b~%s~s~',
  ['received_weapon_withammo'] = '你收到了~b~%s~s~和~o~%sx~s~弹药，来自~b~%s~s~',
  ...
  ['threw_weapon_ammo'] = '你丢弃了~b~%s~s~和~o~%sx~s~弹药',
  -- Salary related
